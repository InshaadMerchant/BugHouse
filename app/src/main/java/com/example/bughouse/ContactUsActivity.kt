    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            MainNavigationDrawerContent(
                ...
                currentScreen = "ContactUs" // Mark this as the current screen
            )
        },
        ...
        Scaffold(
            ...
            Box(
                ...
                Column(
                        ...
                        Column(
                            ...
                            Button(
                                onClick = {
                                    ...
                                    if (!studentIdError && !nameError && !subjectError && !messageError) {
                                        // Send message
                    ...
                    Text(
                        text = "For urgent matters requiring immediate assistance, please contact: founders@bughouse.com",
                        fontSize = 12.sp,
                        color = Color.Gray,
                        textAlign = TextAlign.Center,
